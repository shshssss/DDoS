...
while True:
    print("Packet sent to " + ipaddress + " With port 80")


#Hello devs this is indeed a fake this my first python project you aim to make a real ddos service in the future if you have any tips 
#Please contact my discord ox_oop thank you
